...
#PKG_NAMES="Core Gui RobotAPI MemoryX VisionX Spoac SimulationX RobotSkills Armar3 Armar4"
PKG_NAMES="Core Gui RobotAPI MemoryX VisionX SimulationX RobotSkills Armar3 Armar4"
BASEDIR=~/armarx/
